    ...
    <div class="container">
        ...
        <form action="/inscription" id="formulaire" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="nom" id="nom" required oninput="script_balise(this)">
            </div>
            <br>
            <div class="form-group">
                <label for="prenom">Veuillez saisir votre prénom</label>
                <input type="text" name="prenom" id="prenom" required oninput="script_balise(this)">
            </div>
            <br>
            <div class="form-group">
                <label for="mail">Veuillez saisir votre Adresse mail</label>
                <input type="email" name="mail" id="mail" required oninput="script_balise(this)">
            </div>
            <br>
            <div class="form-group">
                <label for="mdp">Veuillez saisir votre mot de passe</label>
                <input type="password" name="mdp" id="mdp" oninput="validate()" required oninput="script_balise(this)">
                <span id="message_conforme"></span>
            </div>
            <br>
            <div class="form-group">
                <label for="confirmmdp">Veuillez confirmer votre mot de passe</label>
                <input type="password" name="confirmmdp" id="confirmmdp" oninput="same_password()" required
                    oninput="script_balise(this)">
